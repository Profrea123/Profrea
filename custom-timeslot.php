...
?>
        ...
        <div class="container">
                ...
                <div class="row pt-5 pb-5 align-items-center">
                    <div class="col-md-8 col-7 ">
                        <h1 class="website-detailhead f1 ft-32 fw-bold">Custom TimeSlot</h1>
                    </div>
                    <div class="col-md-4 col-5">
                        <div class="edit-web text-blue"> 
                            <a href="Profile-view">Back</a>
                        </div>
                    </div>
                            ...
                            <div class="row pt-5 bg-white mt-5 pb-3">
                                ...
                                <form id="timeslot" method="POST" novalidate>   
                                    ...
                                    <div class="col-lg-12 col-12 ml-10 p-2">
                                        <!-- Slot Type -->
                                        <div class="row pt-2 pb-4 p-4 mt-3" >
                                            <div class="col-lg-5 col-5 ml-10  d-md-flex">
                                                <div class="col-lg-3 col-3 ">
                                                    <label>Choose Type</label>
                                                </div>
                                                <?php
                                                    $list_of_slots = ['audio', 'video', 'clinic'];
                                                    foreach($list_of_slots as $result_day_slot) {
                                                    ?>
                                                
                                                <div class="col-lg-2 col-2 ">
                                                    <input type="checkbox" class="Choosen_slot_type" id="" data-slot_type = "<?php echo $result_day_slot;?>" name="<?php echo $result_day_slot;?>" value=""> 
                                                </div>
                                                <div class="col-lg-2 col-2">
                                                    <label><?php echo ucfirst($result_day_slot); ?> </label>
                                                </div>
                                                <?php } ?>
                                            </div>
                                        </div>
                                                        <!-- Audio -->
                                        <div class="border border-gray p-2" id="audio_time_slot_div" style="display: none;">
                                            <h4 class="p-3">Audio Time Slot</h4>
                                            <!-- Days -->
                                            <div class="row pt-2 pb-4 p-4">
                                                <div class="col-lg-5 col-5 ml-10  d-md-flex">
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                        <div class="col-lg-2 col-2 ">
                                                            <input type="checkbox" class="days" name="audio_<?php echo $result_day;?>" value="<?php echo $result_day;?>"> 
                                                        </div>
                                                        <div class="col-lg-2 col-2">
                                            ...
                                            <div class="row pt-2 pb-4 p-4">
                                                <div class="col-lg-12 col-12 ml-10 websiteformfield d-md-flex">
                                                    <div class="col-lg-3 col-3 display_grid">
                                                        ...
                                                        <select class="p-2 col-lg-6 col-6 slot_interval" data-time="audio_slot" name="audio_slot_interval" id="audio_slot_interval" required>
                                                            <?php for($i=1; $i <= 12; $i++) {
                                                                $time_increment         = $i * 5;
                                                    ...
                                                    <div class="row col-12 p-2">
                                                        <div class="col-lg-12 col-12 mt-4  websiteformfield d-md-flex">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="col-lg-12">
                                                                    <div class="row mb-3">
                                                                        <div class="col-lg-3 col-3 mb-12">
                                                                            ...
                                                                            <input type="text" class="check_time_list_validate timepicker form-control" data-time='audio_slot'  id="audio_slot_start_time" name="audio_slot_start_time" value="" >
                                                                            <span class="ml-5 text-danger" id="start_time_error"></span>
                                                                        </div>
                                                                        <div class="col-lg-3 col-3 ml-2 mb-12">
                                                                            <label>End Time</label>
                                                                            <input type="text" class="check_time_list_validate timepicker form-control" data-time='audio_slot' id="audio_slot_end_time" name="audio_slot_end_time" value="" >
                                                                            <span class="ml-5 text-danger" id="end_time_error"></span>
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                                <div class="col-xl-12" id="audio_slot_times_list_div"></div>
                                                            </div> 
                                                        </div> 
                                                    </div>
                                                </div>
                                                                ...
                                                                <!-- Video -->
                                        <div class="border border-gray p-2 mt-3" id="video_time_slot_div" style="display: none;">
                                            <h4 class="p-3">Video Time Slot</h4>
                                            <!-- Days -->
                                            <div class="row pt-2 pb-4 p-4">
                                                <div class="col-lg-5 col-5 ml-10  d-md-flex">
                                                    <div class="col-lg-2 col-2">
                                            ...
                                            <div class="row pt-2 pb-4 p-4">
                                                <div class="col-lg-12 col-12 ml-10 websiteformfield d-md-flex">
                                                    <div class="col-lg-3 col-3 display_grid">
                                                        <label>Slot Interval</label>
                                                        <select class="p-2 col-lg-6 col-6 slot_interval" name="video_slot_interval" data-time="video_slot" id="video_slot_interval" required>
                                                            <?php for($i=1; $i <= 12; $i++) {
                                                                $time_increment         = $i * 5;
                                                                $slot_time_generation   = $time_increment .' MIN';
                                                                ?>
                                                            ...
                                                            <div class="col-lg-9" >
                                                                <div class="col-lg-12">
                                                                    <div class="row mb-3">
                                                                        <div class="col-lg-3 col-3 mb-12">
                                                                            <label>Start Time</label>
                                                                            <input type="text" class="check_time_list_validate timepicker form-control" data-time='video_slot'  id="video_slot_start_time" name="video_slot_start_time" value="" >
                                                                            <span class="ml-5 text-danger" id="start_time_error"></span>
                                                                        </div>
                                                                        <div class="col-lg-3 col-3 ml-2 mb-12">
                                                                            <label>End Time</label>
                                                                            <input type="text" class="check_time_list_validate timepicker form-control" data-time='video_slot'  id="video_slot_end_time" name="video_slot_end_time" value="" >
                                                                            <span class="ml-5 text-danger" id="end_time_error"></span>
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                                ...
                                                                <!-- Clinic -->
                                        <div class="border border-gray p-2 mt-3" id="clinic_time_slot_div" style="display: none;">
                                            <h4 class="p-3">Clinic Time Slot</h4>
                                            <!-- Days -->
                                            <div class="row pt-2 pb-4 p-4">
                                                <div class="col-lg-5 col-5 ml-10  d-md-flex">
                                                    <div class="col-lg-2 col-2">
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                        <div class="col-lg-2 col-2 ">
                                                            <input type="checkbox" class="" required name="weekdays[]" value="<?php echo $result_day;?>"> 
                                                        </div>
                                                        <div class="col-lg-2 col-2">
                                                            <label><?php echo ucfirst($result_day); ?> </label>
                                                        </div>
                                            ...
                                            <div class="row pt-2 pb-4 p-4">
                                                <div class="col-lg-12 col-12 ml-10 websiteformfield d-md-flex">
                                                    <div class="col-lg-3 col-3 display_grid">
                                                        <label>Slot Interval</label>
                                                        <select class="p-2 col-lg-6 col-6 slot_interval" data-time="clinic_slot" name="clinic_slot_interval" id="clinic_slot_interval" required>
                                                            <?php for($i=1; $i <= 12; $i++) {
                                                                $time_increment         = $i * 5;
                                                                $slot_time_generation   = $time_increment .' MIN';
                                                                ?>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row col-12 p-2">
                                                        <div class="col-lg-12 col-12 mt-4  websiteformfield d-md-flex">
                                                            ...
                                                            <div class="col-lg-9"  id="day_time_slot_div">
                                                                <div class="col-lg-12">
                                                                    <div class="row mb-3">
                                                                        <div class="col-lg-3 col-3 mb-12">
                                                                            <label>Start Time</label>
                                                                            <input type="text" class="check_time_list_validate timepicker form-control" data-time='clinic_slot' id="clinic_slot_start_time" name="clinic_slot_start_time" value="" >
                                                                            <span class="ml-5 text-danger" id="start_time_error"></span>
                                                                        </div>
                                                                        <div class="col-lg-3 col-3 ml-2 mb-12">
                                                                            <label>End Time</label>
                                                                            <input type="text" class="check_time_list_validate1 timepicker form-control"  data-time='clinic_slot' id="clinic_slot_end_time" name="clinic_slot_end_time" value="" >
                                                                            <span class="ml-5 text-danger" id="end_time_error"></span>
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                                <div class="col-xl-12" id="clinic_slot_times_list_div"></div> 
                                                            </div> 
                                                        </div> 
                                                    </div>
                                                </div>
    ...
    $(function () {
        $(document).ready(function(){
            $(".Choosen_slot_type").on('click',function(){
                var slot_type = $(this).data('slot_type');
                if($(this).is(':checked') && slot_type == 'audio') {
                    $('#'+slot_type+'_time_slot_div').show();
                    // $('#start_time, #end_time').prop('required',true);
                    // $('#'+day+'_start_time, #'+day+'_end_time').val('');
                    $(this).val(1);
                } 
                else if($(this).is(':checked') && slot_type == 'video'){
                    $('#'+slot_type+'_time_slot_div').show();
                    $(this).val(2);
                }
                else if($(this).is(':checked') && slot_type == 'clinic'){
                    $('#'+slot_type+'_time_slot_div').show();
                    $(this).val(3);
                }
                 else {
                    $('#'+slot_type+'_time_slot_div').hide();
                    $(this).val('');
                }
            });
        });
