...
$allData = $real_estate->viewDataWithSpaceFilter('Wellness Center');
...
<section class="bg-video-layout">
    <div class="container">
        <div class="row pt-5 pb-5 align-items-center">
            ...
            <div class="col-md-6">
                <h2 class="pract-head f1">One-point solution for Fitness Professionals</h2>
                <p class="ft-16 pt-4 text-grey">Book Fitness Centers or spaces directly from Website on hourly basis</p>
                <div class="explore-clinicsbtn mt-5">
                    <a href="spaces">Explore Fitness centers</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row pt-3">
                        ...
                        <div class="col-md-3 col-sm-6 d-flex align-self-stretch pb-4 pb-md-0">
                            ...
                            Customize plans
                                ...
                                <p class="timepara text-grey ft-16 pt-3">Customize your own plan choose days and hrs in the week you want to user as per your need</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 d-flex align-self-stretch pb-4 pb-md-0">
                            <div class="timebox text-center w-100 active">
                        ...
                        <div class="col-md-3 col-sm-6 d-flex align-self-stretch pb-4 pb-md-0">
                            ...
                            Earn 2X
                                ...
                                <p class="timepara text-grey ft-16 pt-3">Earn 2X of what you earn by reaching upto 10,000+ customers</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-3 mb-5 d-flex align-self-stretch">
                <div class="benefit-box w-100 text-center">
                    ...
                    <h4 class="ft-16 pt-3 text-grey">Appointment Scheduling Software</h4>
                </div>
            </div>
        </div>
    </div>
