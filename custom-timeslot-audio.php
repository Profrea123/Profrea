        ...
        <div class="container">
                ...
                <div class="row pt-5 pb-5 align-items-center">
                    <div class="col-md-8 col-7 ">
                        <h1 class="website-detailhead f1 ft-32 fw-bold">Custom TimeSlot Audio</h1>
                    </div>
                                            ...
                                            <div class="row pt-2 pb-4 p-4">
                                                <div class="col-lg-12 col-12 ml-10 websiteformfield d-md-flex">
                                                    <div class="col-lg-3 col-3 display_grid">
                                                        ...
                                                        <select class="p-2 col-lg-6 col-6 slot_interval" data-time="audio_slot" name="slot_interval" id="audio_slot_interval" required>
                                                            <?php for($i=1; $i <= 12; $i++) {
                                                                $time_increment         = $i * 5;
                                                    ...
                                                    <div class="col-lg-3 col-3 display_grid">
                                                        ...
                                                        <input type="number" name="booking_open_upto" min="1" required class="p-2 col-lg-6 col-6" <?php if(isset($row_website_details["audio_booking_open_upto"])) { ?> value="<?php echo $row_website_details["audio_booking_open_upto"]; ?>" <?php } ?>>
                                                    ...
                                                    <div class="col-lg-3 col-3 display_grid">
                                                        ...
                                                        <input type="number" step="any" min="1" name="amount" required class="p-2 col-lg-6 col-6" <?php if(isset($row_website_details["audio_amount"])) { ?> value="<?php echo $row_website_details["audio_amount"]; ?>" <?php } ?>>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row col-12 p-2">
                                                        <div class="col-lg-12 col-12 mt-4  websiteformfield d-md-flex">
                                                            ...
                                                            <input type="hidden" name="slot_type" id="slot_type" value="audio" readonly>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="row mb-3">
                                                                        <div class="col-lg-3 col-3 mb-12">
                                                                            ...
                                                                            <input type="text" class="check_time_list_validate timepicker form-control" data-time='audio_slot'  id="audio_slot_start_time" name="slot_start_time" value="" required>
                                                                            <span class="ml-5 text-danger" id="start_time_error"></span>
                                                                        </div>
                                                                        <div class="col-lg-3 col-3 ml-2 mb-12">
                                                                            <label>End Time</label>
                                                                            <input type="text" class="check_time_list_validate timepicker form-control" data-time='audio_slot' id="audio_slot_end_time" name="slot_end_time" value="" required>
