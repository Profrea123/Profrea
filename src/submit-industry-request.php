...
if($_FILES['space_profile_image']['name'] != ''){
  ...
  $location= $_SERVER['DOCUMENT_ROOT'].'/datafiles/spaces/'.$last_id.'/space_image_profile';
...
if($_FILES['space_image']['name'] != ''){
  $test = explode(".", $_FILES['space_image']['name']);
  $extension = end($test);
  ...
  $location= $_SERVER['DOCUMENT_ROOT'].'/datafiles/spaces/'.$last_id.'/space_images';
  ...
  try{
    move_uploaded_file($_FILES['space_image']['tmp_name'],$locationImage);
  }catch(Exception $e){
      print_r($e);
  }
}
...
if($_FILES['identity_proof']['name'] != ''){
  ...
  $location= $_SERVER['DOCUMENT_ROOT'].'/datafiles/spaces/'.$last_id.'/space_docs/identity_proof';
...
if($_FILES['space_ownership_docs']['name'] != ''){
  ...
  $location= $_SERVER['DOCUMENT_ROOT'].'/datafiles/spaces/'.$last_id.'/space_docs/space_ownership_docs';
...
if($_FILES['noc']['name'][0] != ''){
  ...
  $location= $_SERVER['DOCUMENT_ROOT'].'/datafiles/spaces/'.$last_id.'/space_docs/noc_name';
...
if($_FILES['other_docs']['name'] != ''){
  ...
  $location= $_SERVER['DOCUMENT_ROOT'].'/datafiles/spaces/'.$last_id.'/space_docs/other_docs_name';
...
$queryUpdate = " UPDATE space_info SET `other_docs` = '$other_docs_name', `noc_name` = '$noc_name', `space_ownership_docs_name` = '$space_ownership_docs_name', `space_image_name` = '$space_image_name', `identity_proof_name` = '$identity_proof_name', `space_profile_image` = '$space_profile_image_name' WHERE id = $last_id";

$dbresult = $db_conn->getDbHandler()->query($queryUpdate); 

  if( $dbresult )
  {
    //echo ($_POST['work_img']['name'][0]);
