...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">Health Condition
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mt-2">Edit Health Condition</h3>
                            <div class="text-right">
                                <a class="btn btn-success" href="{{ route('admin.condition.index') }}"> Back</a>
                            </div>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route('admin.condition.update',$test->hc_id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
