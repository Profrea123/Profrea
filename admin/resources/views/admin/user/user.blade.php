            ...
            <div class="card-body">
                <div class="row">
                  ...
                  @if (!empty(request()->name) || !empty(request()->email) || !empty(request()->phone))
                    <a href="{{route('admin.user')}}"><button type="button" class="ml-2 btn btn-rounded btn-danger filter"><i class="fa fa-redo"></i></button> </a>
                  @endif
                </div>
              ...
              <table class="table table-bordered" style="width: 100%">
                ...
                <tbody>
                  <?php  $s =1; foreach ($users as $key => $user) { ?>
                    <tr>
                      <td><?php echo $s; ?></td>
  ...
  <script>
    $(document).ready(function(){
      $('.filter').click(function (){
        ...
        var email = $('#email').val();
        var phone = $('#phone').val();
        var url = "{{route('admin.user')}}"+'?name='+name+'&email='+email+'&phone='+phone;
