                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mt-2">Chat Box log</h3>
                            <div class="text-right">
                                <a class="btn btn-success" href="{{ url('admin/doctor/chat-list') }}"> Back</a>
                            </div>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer" style="display: block;">
                            <form action="<?php echo url('admin/doctor/chat-add'); ?>" method="post">
                            @csrf
                                ...
                                <input type="text" name="message" placeholder="Type Message ..." class="form-control" required>
                                    ...
                                    <input type="hidden" name="reply_on" value="{{ $chat_list[$reply_on]->cb_id }}">
