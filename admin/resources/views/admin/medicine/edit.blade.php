                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mt-2">Edit Medicine</h3>
                            <div class="text-right">
                                <a class="btn btn-success" href="{{ route('admin.medicine.index') }}"> Back</a>
                            </div>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route('admin.test.update',$test->m_id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
