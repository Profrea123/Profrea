                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mt-2">Add New Booking</h3>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="feature_list_id" class="form-control">
                                                ...
                                                foreach ($feature_list as $key => $feature) 
                                                {
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $feature_id; ?>"><?php echo $feature_name; ?></option>;
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="booking_amount" class="form-control" placeholder="booking_amount">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-4">
                                        <div class="form-group">
