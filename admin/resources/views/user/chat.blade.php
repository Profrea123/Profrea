    ...
    <div class="container"> 
        <div class="row bootstrap snippets pt-5">
            ...
            <div class="box box-primary direct-chat direct-chat-primary">
                ...
                <div class="clearfix">
                    <h3 class="float-left box-title">Chat with Doctor</h3>
                ...
                <div class="box-footer">
                    <form action="<?php echo url('user/chat-add'); ?>" method="post">
                    @csrf
                        <div class="input-group">
                        <input type="text" name="message" placeholder="Type Message ..." class="form-control" required>
                        <input type="hidden" name="user_id" value="<?php echo $booking_details->user_id; ?>" class="form-control">
                        <input type="hidden" name="dr_id" value="<?php echo $booking_details->doctor_id; ?>" class="form-control">
