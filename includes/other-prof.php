<form class="pt-3" id="otherForm" action="#" method="POST" novalidate>
<div class='full-input p-2 col-md-12 me-4 mb-3'>
    ...
    <div class='full-input p-2 col-md-12 me-4 mb-3'>
        <label for="exampleInputPassword1" class="form-label text-grey ft-14 mb-0">Profession *</label>
        <input type="text" name='email' required data-parsley-minlength="4" placeholder="Enter Your Profession">
    </div>
    <div class='full-input p-2 col-md-12 me-4 mb-3'>
        <label for="exampleInputPassword1" class="form-label text-grey ft-14 mb-0">Mail *</label>
        <input type="text" name='email' required data-parsley-minlength="4" placeholder="Enter Your Mail">
    </div>
    <div class='full-input p-2 col-md-12 me-4 mb-3'>
        <label for="exampleInputPassword1" class="form-label text-grey ft-14 mb-0">Phone *</label>
