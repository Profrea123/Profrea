            ...
            <div class="row pt-4 pb-4 align-items-center">
                ...
                <div class="col-lg-6 col-md-6  text-end pt-2 pb-2 pt-md-0 pb-md-0 d-none d-md-block">
                    <ul class="list-group list-group-horizontal list-unstyled top-socialheader">
                        <li><a href="https://www.facebook.com/"><i class="text-grey ft-18 fab fa-facebook-f"></i></a></li>
                        <li><a href="https://www.instagram.com/"><i class="text-grey ft-18 fab fa-instagram"></i></a></li>
                        <li><a href="https://twitter.com/?lang=en"><i class="text-grey ft-18 fab fa-twitter"></i></a></li>
                        <li><a href="https://myaccount.google.com/intro/profile"><i class="text-grey ft-18 fab fa-google-plus-g"></i></a></li>
                        <li><a href="https://www.linkedin.com/signup"><i class="text-grey ft-18 fab fa-linkedin-in"></i></a></li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="row pt-5 pb-5">
                <div class="col-lg-7 col-md-12">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4"><img src="images/w1.png" class="img-fluid" alt="" title=""></div>
                        <div class="col-lg-8 col-md-8 col-sm-8">
                            <h1 class="f1 ft-32 fw-bold">Dr.Anamika,<span class="text-grey ft-14">Verified By <a href="" class="text-blue ft-14">Profrea</a></span></h1>
                            <h3 class="degree-studies ft-16 pb-2 pt-2">MBBS,MD,</h3>
                            <h6 class="ft-16 pb-2"><span class="text-grey">Specialist:</span> General (Physician)</h6>
                            <h6 class="ft-16 pb-2"><span class="text-grey">Experience:</span> 8 Years Experience Overall</h6>
                            <div>
                        ...
                        <div class="col-lg-12 pt-5 pb-5 ownprofile-tab">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <p class="ft-16 text-grey p-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation llamco laboris nisi ut aliquip ex ea commodo consequat.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.laboris nisi ut aliquip ex ea</p>
                                </div>
