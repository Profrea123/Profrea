                        ...
                        <div class="col-lg-8 col-8 ps-0 ps-md-2 dropdown-new">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="profile_menu">
                                ...
                                <?php if($row_user['profession_id'] == 1){ ?>
                                    <li><a class="dropdown-item" href="admin/public/doctor/booking/<?php echo $_SESSION['ap_profrea_login_id']; ?>" title="Booking History">Booking History</a></li>
                                    <li><a class="dropdown-item" href="admin/public/doctor/follow-up/<?php echo $_SESSION['ap_profrea_login_id']; ?>" title="Your Schedule">Follow Up</a></li>
                                    <li><a class="dropdown-item" href="admin/public/doctor/smart-prescription/<?php echo $_SESSION['ap_profrea_login_id']; ?>" title="Smart Prescription">Smart Prescription</a></li>
                                <?php }else{ ?>
                                    <li><a class="dropdown-item" href="booking-history">Booking History</a></li>
                                <?php } ?>
                                <!-- <?php if($row_user['profession_id'] == 1){ ?>
                                <li><a class="dropdown-item" href="admin/public/doctor/calendar/<?php echo $_SESSION['ap_profrea_login_id']; ?>" title="Your Schedule">Schedule</a></li>
                            <?php }else{ ?>
                                <li><a class="dropdown-item" href="admin/public/user/calendar/<?php echo $_SESSION['ap_profrea_login_id']; ?>" title="Doctor's Schedule">Schedule</a></li>
                            <?php }?> -->
